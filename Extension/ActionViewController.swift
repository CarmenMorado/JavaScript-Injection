...
//  Extension
//
//  Created by Carmen Morado on 4/2/21.
//
...
class ActionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Preset Script", style: .done, target: self, action: #selector(alertOptions))
